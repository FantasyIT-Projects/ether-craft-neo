...
public class EtherStreamDamagePlatingEffect implements IPlatingEffect, IPlatingRightClickTrigger {
    public static final Identifier ID = EtherCraft.id("ether_stream_damage");
    ...
    public void apply(IPlatingEffect effect, PlatingData data, ItemStack stack, LivingEntity entity, PlayerInteractEvent.RightClickItem event) {
        ...
        PlatingData updated = data.copyWithCoolDown(level, Config.platingEtherStreamDamageCdTicks);
