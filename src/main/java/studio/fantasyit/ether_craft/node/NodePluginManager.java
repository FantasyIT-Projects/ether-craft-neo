...
public class NodePluginManager {
    ...
    static {
        ...
        ALL_PLUGINS.add(new PluginInfo(PluginType.UPGRADE, MiniStorageUpgrade.ID, MiniStorageUpgrade::new, t -> t.is(Items.DECORATED_POT), Items.DECORATED_POT));
        ...
        ALL_PLUGINS.add(new PluginInfo(PluginType.FEATURE, FeatureEtherStreamProperty.ID, FeatureEtherStreamProperty::new, t -> t.is(Items.BARRIER), Items.BARRIER));
    }
