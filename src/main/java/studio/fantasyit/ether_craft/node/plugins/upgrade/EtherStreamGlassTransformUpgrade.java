...
public class EtherStreamGlassTransformUpgrade extends AbstractNodePlugin implements IEtherStreamCapabilityProviderPlugin {
    public static final Identifier ID = EtherCraft.id("glass_transform_upgrade");

    public EtherStreamGlassTransformUpgrade(EtherAdaptNodeEntity nodeEntity, InstalledPlugin installedId) {
