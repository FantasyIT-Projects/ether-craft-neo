...
public class FunctionNodeProcessScreen extends BaseEtherNodeTabWidgetProvider<FunctionNodeProcess> {
    public FunctionNodeProcessScreen(FunctionNodeProcess menuContext, EtherAdaptNodeScreen screen) {
    ...
    public void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        FilterGuiRegClient.widget(screen, context.targetItemFilter.whitelist, FunctionNodeProcess.FILTER_PREFIX);
    }
}