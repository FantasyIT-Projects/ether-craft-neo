...
public class BlockEntityRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, @NotNull BlockEntityType<@NotNull EtherAdaptNodeEntity>> ETHER_NODE_ENTITY = BLOCK_ENTITIES_TYPE.register("ether_node", () -> new BlockEntityType<>(EtherAdaptNodeEntity::new, BlockRegistry.ETHER_STREAM_EMITTER.get()));
