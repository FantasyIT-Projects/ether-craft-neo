...
public class Config {
    ...
    private static final ModConfigSpec.IntValue NODE_EQUIPMENT_GENERATOR_COEFFICIENT = BUILDER
            ...
            .defineInRange("node.equipment_generator.coefficient", 100, 1, 10000);
    private static final ModConfigSpec.IntValue NODE_EQUIPMENT_GENERATOR_BASE_AMOUNT = BUILDER
            ...
            .defineInRange("node.equipment_generator.base_amount", 10, 1, Integer.MAX_VALUE);
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> NODE_ENCHANTER_ETHER_COSTS = BUILDER
            ...
            .defineList("node.enchanter.ether_costs", () -> List.of(4096, 8192, 16384), () -> 0, t -> {
                try {
                    if (t instanceof Integer) return true;
                    Integer.parseInt(t.toString());
                    return true;
    ...
    private static final ModConfigSpec.IntValue ETHER_STREAM_DISPLAY_TIME_CACHE_TICK = BUILDER
            .comment("Ticks the precomputed DisplayTime collision end point stays cached before rescanning")
            .defineInRange("ether_stream.display_time.cache_tick", 20, 1, Integer.MAX_VALUE);
    ...
    public static int etherStreamDisplayTimeCacheTick;
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        etherStreamDisplayTimeCacheTick = ETHER_STREAM_DISPLAY_TIME_CACHE_TICK.get();
