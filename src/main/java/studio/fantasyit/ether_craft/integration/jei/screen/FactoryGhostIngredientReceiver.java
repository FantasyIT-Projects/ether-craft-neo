...
public class FactoryGhostIngredientReceiver implements IGhostIngredientHandler<EtherProcessFactoryScreen> {
    @Override
    public <I> List<Target<I>> getTargetsTyped(EtherProcessFactoryScreen gui, ITypedIngredient<I> ingredient, boolean doStart) {
